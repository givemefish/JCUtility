...
namespace JCUtility.Common
{
    ...
    public static class Ensure
    {
        ...
        /// <exception cref="System.Exception">Thrown when condition is false</exception>
        ...
        /// <summary>
        /// Ensures that the given expression is false
        /// </summary>
        /// <param name="condition">Condition to test/ensure</param>
        /// <param name="message">Message for the exception</param>
        /// <exception cref="System.Exception">Thrown when condition is true</exception>
